                    ...
                    {dados.map((data, index) => (
                        <View key={index}>
                          <View style={styles.box}>
                                   ...
                                   {/*<View style={styles.box}>
                                        <View style={styles.textos}>
                                            <Text style={styles.lenghtText2}>Informações Profissionais{}</Text>
                                             <Text style={styles.paragraph}>
                                                    {`  `}
                                            </Text>

                            
                                            <Text style={styles.sText}>Caminhão: {data.caminhao} </Text>
                                            <View style={styles.caixa1}></View>

                                            <Text style={styles.sText}>Eixos:{data.eixo} </Text>
                                            <View style={styles.caixa1}></View>
