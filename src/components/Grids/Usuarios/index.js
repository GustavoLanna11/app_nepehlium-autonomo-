                ...
                <View>
                    ...
                    >                   
                        ...
                        >     
                            ...
                            <Text style={{ color: '#000', fontSize:12 }}>{data.nome} - {data.eixo}</Text>
...
<Modal 
      ...
      >
         ...
         <Text style={styles.Cliente}>{data.nome} - {data.eixo}</Text>
                ...
                <View style={styles.Section}>
                    ...
                    <Text style={styles.Entrada}>Nome {data.nome}</Text>
